...
<?php $nk_unique_id = esc_attr( uniqid( 'search-form-' ) ); ?>
<form role="search" method="get" class="search-form cell medium-12 grid-x" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	...
	<div class="input-group cell medium-12 grid-x">
		<input type="search" id="<?php echo $nk_unique_id; ?>" class="input-group-field" placeholder="<?php _e( 'جستجو ...', 'nokhbe' ); ?>" value="<?php echo get_search_query(); ?>" name="s" />
